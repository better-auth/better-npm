...
const REGISTRY_HOST = process.env.BETTER_NPM_REGISTRY || (DEV ? "localhost:8787" : "registry.better-npm.dev");
const REGISTRY_URL = process.env.BETTER_NPM_REGISTRY_URL || (DEV ? "http://localhost:8787" : `https://${REGISTRY_HOST}`);
const WEB_URL = process.env.BETTER_NPM_WEB_URL || (DEV ? "http://localhost:3001" : "https://better-npm.com");
